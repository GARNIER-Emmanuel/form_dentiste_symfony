...
class InfoClientController extends AbstractController
{
    ...
    public function index(InfoClientRepository $infoClientRepository, AuthenticationUtils $authenticationUtils): Response
    {
    ...
    public function new(Request $request, InfoClientRepository $infoClientRepository, AuthenticationUtils $authenticationUtils): Response
    {
    ...
    public function show(InfoClient $infoClient,  AuthenticationUtils $authenticationUtils): Response
    {
        $lastUsername = $authenticationUtils->getLastUsername();
    ...
    public function edit(Request $request, InfoClient $infoClient, InfoClientRepository $infoClientRepository, AuthenticationUtils $authenticationUtils): Response
    {
        $form = $this->createForm(InfoClientType::class, $infoClient);
        $form->handleRequest($request);
        $lastUsername = $authenticationUtils->getLastUsername();
    ...
    public function delete(Request $request, InfoClient $infoClient, InfoClientRepository $infoClientRepository, AuthenticationUtils $authenticationUtils): Response
    {
        $lastUsername = $authenticationUtils->getLastUsername();
        ...
        return $this->redirectToRoute('app_infoclient_index', ['last_username' => $lastUsername,], Response::HTTP_SEE_OTHER);
    }
}
